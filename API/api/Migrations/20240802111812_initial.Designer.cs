...
namespace api.Migrations
{
    ...
    [Migration("20240802111812_initial")]
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "ec1a361e-b4f1-4b6d-b1d1-a32dad832d70",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "872f0019-7b35-4427-91a9-ab9aeb0667a9",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("api.Models.Address", b =>
                {
                    ...
                    b.HasOne("api.Models.Donor", "donor")
                        .WithOne("address")
                        .HasForeignKey("api.Models.Address", "DonorId")
                        .OnDelete(DeleteBehavior.Cascade);
